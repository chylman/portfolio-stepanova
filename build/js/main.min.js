...
/* harmony import */ var _modules_tippy_init_tippy_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tippy/init-tippy.js */ "./js/modules/tippy/init-tippy.js");
/* harmony import */ var _modules_animation_init_animation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/animation/init-animation.js */ "./js/modules/animation/init-animation.js");
/* harmony import */ var _modules_clipboard_init_clipboard_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/clipboard/init-clipboard.js */ "./js/modules/clipboard/init-clipboard.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_tippy_init_tippy_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
    Object(_modules_animation_init_animation_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
    Object(_modules_clipboard_init_clipboard_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
  });
});
...
var initAnimation = function initAnimation() {
  var contactsOpacityHeader = gsap.to('[data-animation-contacts-header="opacity"]', {
    paused: true,
    opacity: 1,
  ...
  var contactsOpacity = gsap.to('[data-animation-contacts="opacity"]', {
    opacity: 0,
    duration: 0.3,
    ease: "power4.out",
    pointerEvents: 'none',
...
/***/ "./js/modules/clipboard/init-clipboard.js":
/*!************************************************!*\
  !*** ./js/modules/clipboard/init-clipboard.js ***!
  \************************************************/
/*! exports provided: default */
...
var initClipboard = function initClipboard() {
  var clipboardBlocks = document.querySelectorAll('[data-clipboard]');
  clipboardBlocks.forEach(function (item) {
    if (!item) {
      return;
    }
    var textItem = item.querySelector('[data-clipboard-text]');
    var trigger = item.querySelector('[data-clipboard-button]');
    if (!textItem || !trigger) {
      return;
    }
    var handleTriggerClick = function handleTriggerClick() {
      var text = textItem.dataset.clipboardText;
...
/* harmony default export */ __webpack_exports__["default"] = (initClipboard);
...
/***/ "./js/modules/tippy/init-tippy.js":
/*!****************************************!*\
  !*** ./js/modules/tippy/init-tippy.js ***!
  \****************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tippy_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tippy.js */ "../node_modules/tippy.js/dist/tippy.esm.js");
/* harmony import */ var _clipboard_init_clipboard_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../clipboard/init-clipboard.js */ "./js/modules/clipboard/init-clipboard.js");


var initTippySuccessfully = function initTippySuccessfully() {
  Object(tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-tippy-successfully]', {
    trigger: 'click',
    theme: 'white',
    arrow: false,
    placement: 'bottom',
...
var initTippyContent = function initTippyContent() {
  Object(tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-tippy-content]', {
    ...
    arrow: true,
    onShown: function onShown(instance) {
      Object(_clipboard_init_clipboard_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
      initTippySuccessfully();
      instance.hideWithInteractivity('scroll');
    }
  });
};
/* harmony default export */ __webpack_exports__["default"] = (initTippyContent);
